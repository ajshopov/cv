      ...
      <Container maxWidth="xl" className={classes.blue}>
        <Container maxWidth="sm" className={classes.hero}>
          ...
          <Typography variant="h5" className={classes.intro}>
            ...
            on the following page, or have a browse through some of my favourite 
            <span> <Link className={classes.textLinks} component={RouteLink} color="inherit" to="/booklist">books</Link> </span> and 
